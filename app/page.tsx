...
const FAQ: { q: string; a: string }[] = [
  { q: "어떤 페이지들을 만들 수 있나요?", a: "교회 소개, 예배 안내, 말씀과 주보, 공지, 일정, 갤러리, 부서, 기도 요청, 통독 — 총 9종의 페이지를 제공합니다. 모든 페이지는 관리자 콘솔에서 토글로 켜고 끌 수 있어 우리 교회에 필요한 것만 운영할 수 있습니다." },
